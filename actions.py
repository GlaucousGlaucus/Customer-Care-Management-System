...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
    """ + Fore.RESET)
        ...
        if insert_data_to_csv in lemon_constants['affirmative-confirmation']:
...
Make sure that you have avoided any of the following errors:
    ...
    4. Not a duplicate value
                ...
                if new_data:
                    if input(
                            f"{Fore.CYAN}Do you want to change the value of {Fore.RED}{d_type}?{Fore.RESET} (Y/N) ").strip().lower() in lemon_constants['affirmative-confirmation']:
...
""" + Fore.RESET)
    ...
    if returnable != "Not Returnable":
        ...
        days_to_return = "-"
    # Data Summarization
    new_data = [name, manufacturer, category, stock, avg_rating, returnable, days_to_return]
    if all(new_data):
        print(f"""{Fore.CYAN}
                                    ╔═╗╔═╗╔╗╔╔═╗╦╦═╗╔╦╗  ╔╦╗╔═╗╔╦╗╔═╗
                                    ║  ║ ║║║║╠╣ ║╠╦╝║║║   ║║╠═╣ ║ ╠═╣
...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
    {Fore.RESET}""")
        ...
        if insert_into_csv in lemon_constants['affirmative-confirmation']:
...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀                
            ...
            if cmd == "1":
                ...
                if data_validator_product_bool(products, product_id, new_val, d_type):
                    if input(
                            f"{Fore.CYAN}Do you want to change the value of {Fore.RED}{d_type}?{Fore.RESET} (Y/N) ").lower() in lemon_constants['affirmative-confirmation']:
...
""" + Fore.RESET).strip().lower().title()
    ...
    customer_obj = customers.loc[customerID]
    ...
    prod_name = prod["name"]
    # Data Summarization
    NewData = [customerID, customer_first_name, customer_last_name, productID, prod_name, qty,
               total_price, doo, State, customer_address]
    if all(NewData):
        print(f"""{Fore.CYAN}
                                    ╔═╗╔═╗╔╗╔╔═╗╦╦═╗╔╦╗  ╔╦╗╔═╗╔╦╗╔═╗
                                    ║  ║ ║║║║╠╣ ║╠╦╝║║║   ║║╠═╣ ║ ╠═╣
...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
            ...
            Customer (First Name) :    {Fore.LIGHTMAGENTA_EX}{customer_first_name}{Fore.CYAN}
            Customer (Last Name)  :    {Fore.LIGHTMAGENTA_EX}{customer_last_name}{Fore.CYAN}
            ...
            Address               :    {Fore.LIGHTMAGENTA_EX}{customer_address}{Fore.CYAN}

▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
    {Fore.RESET}""")
        reck = input(
            f"Would you like to insert this data to {Fore.LIGHTGREEN_EX}Orders.csv{Fore.RESET} ? (Y/N): ").strip().lower()
        if reck in lemon_constants['affirmative-confirmation']:
                ...
                if data_validator_order_bool(customers, products, orders, new_val, d_type):
                    ...
                    if input(
                        ...
                        if d_type == "customerID":
                            customer_obj = customers.loc[new_val]
                            orders.at[order_id,
                                      "customerFirstName"] = customer_obj["first_name"]
                            orders.at[order_id, "customerLastName"] = customer_obj["last_name"]
                            orders.at[order_id, "address"] = customer_obj["address"]
...
def add_a_ticket(customers: pd.DataFrame, products: pd.DataFrame, orders: pd.DataFrame, tickets: pd.DataFrame,
                 customer_id=None, register=False):
    cls()
    print(Fore.CYAN +
          """
                       ╔═╗╔╦╗╔╦╗  ╔═╗  ╔╦╗╦╔═╗╦╔═╔═╗╔╦╗
...
""" + Fore.RESET)
    ...
    if register:
        ...
        customer_id = safe_input(Fore.LIGHTMAGENTA_EX +
                            "Enter Customer ID: " + Fore.RESET)
        while customer_id not in customers.index:
            throw_error('error', "Customer ID not found!")
            customer_id = safe_input(Fore.LIGHTMAGENTA_EX +
                                "Enter Customer ID: " + Fore.RESET)
    cls()
    ...
    while (order_id not in orders.index) or (orders.loc[order_id]["customerID"] != customer_id):
    ...
    if not register:
        ...
        # Closing date dependent variables, 
        # > Set to nan if doc is nan.
        first_response_time = np.NaN
        customer_satisfaction = np.NaN
        replies = np.NaN
        if doc_check != "-":
            # FRT
            while first_response_time is np.NaN:
            ...
            while customer_satisfaction is np.NaN:
                customer_satisfaction = safe_input(Fore.LIGHTMAGENTA_EX +
                                    "Enter Customer Satisfaction: " + Fore.RESET, d_type='float', can_be_nan=True)
            cls()

            # Replies
            while replies is np.NaN:
                replies = safe_input(Fore.LIGHTMAGENTA_EX +
                                    "Enter Replies: " + Fore.RESET, can_be_nan=True)
            cls() 
    else:
        doc_check = "-"
        replies = customer_satisfaction = first_response_time = doc = np.nan

    # Get Customer and Product data
    customer_obj = customers.loc[customer_id]
    customer_first_name = customer_obj["first_name"]
    ...
    # Data Summarization
    NewData = [customer_id, order_id, prod_name, prod_category,
               customer_first_name, customer_phone, status, issue_category, issue,
               do, doc, hoursTaken, first_response_time, replies, customer_satisfaction]
    print(f"""{Fore.CYAN}
                                    ╔═╗╔═╗╔╗╔╔═╗╦╦═╗╔╦╗  ╔╦╗╔═╗╔╦╗╔═╗
                                    ║  ║ ║║║║╠╣ ║╠╦╝║║║   ║║╠═╣ ║ ╠═╣
                                    ╚═╝╚═╝╝╚╝╚  ╩╩╚═╩ ╩  ═╩╝╩ ╩ ╩ ╩ ╩
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
                ...
                CustomerID               : {Fore.LIGHTMAGENTA_EX}{customer_id}         {Fore.CYAN}
                ...
                CustomerFirstName        : {Fore.LIGHTMAGENTA_EX}{customer_first_name}{Fore.CYAN}
                CustomerPhone            : {Fore.LIGHTMAGENTA_EX}{customer_phone}     {Fore.CYAN}
                ...
                CustomerSatisfaction(%)  : {Fore.LIGHTMAGENTA_EX}{customer_satisfaction}      {Fore.CYAN}
...
def close_ticket(msg_grp, tickets, ticket_id, admin=False):
    ...
    inter_msg = "Please rate your experience with us: (Rate them on a scale of 1-10) \nHow was our staff's interaction with you ?"
    fr_msg = "Did you receive the first interaction message from our staff quick ?"
    issue_speed_msg = "How quickly your issue was resolved ?"
    if not admin:
        interaction = safe_input(
            Fore.LIGHTMAGENTA_EX + inter_msg + Fore.RESET,
            fail_text=fail_text)
        first_response_time = safe_input(Fore.LIGHTMAGENTA_EX +
                            fr_msg + Fore.RESET,
                            fail_text=fail_text)
        issue_speed = safe_input(Fore.LIGHTMAGENTA_EX +
                                issue_speed_msg + Fore.RESET, fail_text=fail_text)
        satisfaction_value = [x * 10 for x in [interaction, first_response_time, issue_speed]]
        
    tickets.at[ticket_id, "CustomerSatisfaction(%)"] = round(sum(satisfaction_value) / len(satisfaction_value), 2) if not admin else np.nan
    if ticket_id in msg_grp.size().index:
        tickets.at[ticket_id, "Replies"] = msg_grp.size()[ticket_id]
        ticket_msg_grp = msg_grp.get_group(ticket_id)
        fr_date_grp = ticket_msg_grp[ticket_msg_grp['Side'] == "ADMIN"]['Date']
        first_response_date = None
        if not fr_date_grp.empty:
            first_response_date = pd.to_datetime(fr_date_grp.values[0])
        if first_response_date is not None:
            if first_response_date != 0:
                tickets.at[ticket_id, "FirstResponseTime"] = int(
                    (first_response_date - (tickets.loc[ticket_id]["DateOpened"])).seconds // 60)
            else:
                tickets.at[ticket_id, "FirstResponseTime"] = np.nan
        else:
            tickets.at[ticket_id, "FirstResponseTime"] = np.nan
    else:
        tickets.at[ticket_id, "Replies"] = np.nan
        tickets.at[ticket_id, "FirstResponseTime"] = np.nan
    SaveData(tickets, "Tickets")

def update_ticket(customers: pd.DataFrame, products: pd.DataFrame, orders: pd.DataFrame, tickets: pd.DataFrame,
                  customer_id=None, msg_grp=None, close=False):
    cls()
    ticket_id = safe_input(Fore.CYAN + "Ticket ID To Update: " + Fore.RESET)
    if ticket_id not in tickets.index or (close and customer_id != tickets.loc[ticket_id]['CustID']):
        ...
        cls()
        if close:
            close_ticket(msg_grp, tickets, ticket_id)
            return None
        while True:
            cls()
            print(Fore.CYAN +
...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
            ...
            if cmd == "1":
                ...
                if data_validator_ticket_bool(customers, orders, tickets, new_val, d_type):
                    if input(
                            f"{Fore.CYAN}Do you want to change the value of {Fore.RED}{d_type}?{Fore.RESET} (Y/N) ").lower() in lemon_constants['affirmative-confirmation']:
                        if d_type == "DateClosed":
                            close_ticket(msg_grp, tickets, ticket_id, admin=True)
